package com.jingju.jjplayer.permission;
...
import com.jingju.jjplayer.utils.ToastUtils;
...
public class ActivityPermissionDispatcher {
    ...
    public void checkedWithStorage(Activity activity) {
        String array[] ={Manifest.permission.WRITE_EXTERNAL_STORAGE,Manifest.permission.READ_EXTERNAL_STORAGE};
        checkedWithPermissions(activity, array, Constant.PERMISSION_STORAGE_REQUEST_CODE);
    }

//    public void checkedWithReadStorage(Activity activity) {
//        checkedWithPermission(activity, Manifest.permission.READ_EXTERNAL_STORAGE, Constant.PERMISSION_STORAGE_REQUEST_CODE);
//    }
